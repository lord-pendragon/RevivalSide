...
- `gameplay-jsons/`: slim checked-in gameplay table fallback for fresh account defaults, unit rosters, exp tables, and tutorial event decks.
...
Fresh local accounts can use the checked-in `gameplay-jsons` fallback immediately. Generate full local table data from your own CounterSide install when you need the wiki, full extracted table coverage, or asset-dependent features.
